 ...
 * 
 * @author Sci10n
 * This is an example of a graph without any data structure for nodes or edges, it simply generates new states and return them. works for most of the
 * search algorithms since they them self keep track of searched nods
 *
 */
