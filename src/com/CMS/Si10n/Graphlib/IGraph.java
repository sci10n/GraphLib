...
public interface IGraph<T, E> {
    ...
    /**
     * Inputs two AbstractNode:s and returns if there's a edge running from t1
     * to t2
     * 
     * @param t1
     * @param t2
    ...
    /**
     * Adds Node t to the graph. Doesn't add any edges. Stored by hashCode value
     * so make sure you keep a reference to that specific instance
     * 
     * @param t
     */
    ...
    /**
     * Removes Node t to the graph. Doesn't remove any edges (probably should).
     * Removed by hashCode value.
     * 
     * @param t
     */
